...
std::string FetchData()
{
	...
	std::string query = R"(
		[out:xml];
		(
		  way["highway"~"^(motorway|trunk|primary|secondary|tertiary|residential|primary_link|secondary_link|tertiary_link|service|living_street)$"](55.6200,12.4774,55.6938,12.5986);
		);
		out body;
		>;
		out skel qt;
